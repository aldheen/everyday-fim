										...
										<div class="form-body">
											<div class="row">
												...
												<div class="form-group">
													...
													<input type="text" id="" class="form-control"  name="distributor" autocomplete="off"  readonly="yes" value="<?php echo$row['distributor'];?>">
													</div>
												</div>
													<div class="col-md-12">
													<div class="form-group">
													<label for="">Started Year</label>
													<input type="text" id="" class="form-control"  name="year" autocomplete="off"  readonly="yes" value="<?php echo$row['year'];?>">
													</div>
												</div>
