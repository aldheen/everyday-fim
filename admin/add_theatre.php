...
if (isset($_POST['submit'])) {
	...
	// Get text
	$a = mysqli_real_escape_string($conn, $_POST['name_of_theatre_ott']);
	$b = mysqli_real_escape_string($conn, $_POST['username']);

	$c = mysqli_real_escape_string($conn, $_POST['password']);
	$d = mysqli_real_escape_string($conn, $_POST['country']);;
	$image = $_FILES['image']['name'];
	$target = 'images/' . basename($image);

	$sql = "INSERT INTO theatre_ott_tb (name_of_theatre_ott,username,password,country,image) VALUES ('$a','$b','$c','$d','$image')";
	// execute query
	if (mysqli_query($conn, $sql)) {
		if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
			$_GET['status'] = "New Theater/OTT is Added";
			$_GET['error'] = false;
		} else {
			$_GET['error'] = true;
			$_GET['status'] = "Cannnot add Theater/OTT right now";
		}
	} else {
	}
}
		...
		<div class="content-wrapper">
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-xs-12 mb-1">
					<h2 class="content-header-title">Theater</h2>
				</div>
							...
							<div class="col-xs-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title" id="basic-layout-form">Add Theater</h4>
									...
									<form method="POST" action="add_theatre.php" enctype="multipart/form-data">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label for="">Name of Theater/OTT </label>
																	<input type="text" id="" class="form-control" placeholder="First Name" name="name_of_theatre_ott" autocomplete="off">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
