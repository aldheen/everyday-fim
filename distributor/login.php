...
<head>
    ...
    <title>Login - Every Day Films</title>

    <link rel="shortcut icon" type="image/png" href="assets/images/logo/EDFlogo.png">
                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header no-border">
                                <div class="card-title text-xs-center">
                                    <div class="p-1"><img src="assets/images/logo/EDFLogo.png" widht="200" height="150" alt="Every Day Films"></div>
                                </div>
                            </div>
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <form class="form-horizontal form-simple" action="logindistributor.php" method="post">
